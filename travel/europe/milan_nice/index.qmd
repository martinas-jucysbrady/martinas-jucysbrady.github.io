...
<div class="media-block" style="margin: 2rem 0; position: relative; cursor: pointer;">
  <video id="monaco-race" autoplay muted loop playsinline
         style="width: 100%; max-height: 560px; object-fit: cover; object-position: center; border-radius: 6px; display: block;">
  ...
  <div id="monaco-race-icon" style="position: absolute; bottom: 12px; right: 12px; background: rgba(0,0,0,0.5); border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; pointer-events: none;">🔇</div>
  <p class="media-caption">Earlier in the weekend — the F2 race through the streets, the sound arriving before the cars do.</p>
</div>

<div class="media-block" style="margin: 2rem 0; position: relative; cursor: pointer;">
  <video id="monaco-f1" autoplay muted loop playsinline
         style="width: 100%; max-height: 560px; object-fit: cover; object-position: center; border-radius: 6px; display: block;">
  ...
  <div id="monaco-f1-icon" style="position: absolute; bottom: 12px; right: 12px; background: rgba(0,0,0,0.5); border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; pointer-events: none;">🔇</div>
  <p class="media-caption">The F1 race — restricted view, unrestricted sound.</p>
</div>

<script>
  ['monaco-race', 'monaco-f1'].forEach(id => {
