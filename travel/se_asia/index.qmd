...
The North Coast Tour — Yehliu, Shifen, Jiufen {#tour}
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin: 2rem 0;">
  ...
  <figure style="margin: 0;">
    ...
    <figcaption class="media-caption">The summit of Ti Top Island — Ha Long Bay in every direction, fading into the haze.</figcaption>
  </figure>
</div>
...
Hanoi — The City Itself {#hanoi-city}
