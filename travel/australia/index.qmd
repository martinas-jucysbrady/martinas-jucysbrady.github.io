...
<div class="media-row two-col">
  <div class="media-block">
    <img src="busselton_yallingup.jpg" alt="Yallingup coastline, Western Australia" />
    <p class="media-caption">The Yallingup coast — rugged, windswept, and worth every kilometre of the drive.</p>
  </div>
  <div class="media-block">
    <img src="busselton_lighthouse.jpg" alt="Cape Naturaliste Lighthouse" />
    <p class="media-caption">Cape Naturaliste Lighthouse — looking out over open ocean at the tip of the peninsula.</p>
  </div>
</div>
...
<div class="media-row three-col">
  <div class="media-block">
    <img src="busselton_beach.jpg" alt="Beach at Busselton" />
    <p class="media-caption">Geographe Bay.</p>
  </div>
  <div class="media-block">
    <img src="busselton_beach2.jpg" alt="Beach at Busselton" />
    <p class="media-caption">Morning at the beach.</p>
  </div>
  <div class="media-block">
    <img src="busselton_pier.jpg" alt="Busselton foreshore at dusk" />
    <p class="media-caption">The foreshore at dusk.</p>
  </div>
</div>
...
<div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem; margin: 2rem 0;">
  <figure style="margin: 0;">
    <img src="perth_bird.jpg" alt="Tropical bird on a bench, Perth"
         style="width: 100%; height: 380px; object-fit: cover; border-radius: 6px;" />
    <figcaption class="media-caption">The wildlife isn't only in the parks.</figcaption>
  </figure>
  <figure style="margin: 0;">
    <img src="perth-skyline.jpg" alt="Perth skyline from the Swan River"
         style="width: 100%; height: 380px; object-fit: cover; border-radius: 6px;" />
    <figcaption class="media-caption">Perth from the Swan River.</figcaption>
  </figure>
  <figure style="margin: 0;">
    <img src="cottesloe.jpg" alt="Cottesloe Beach, Perth"
         style="width: 100%; height: 380px; object-fit: cover; border-radius: 6px;" />
    <figcaption class="media-caption">Cottesloe Beach — Indian Ocean, no crowds.</figcaption>
  </figure>
</div>
...
<div class="media-block" style="margin: 2rem 0;">
  <video autoplay muted loop playsinline
    ...
    <source src="sydney_manlyferry.mp4" type="video/mp4" />
  </video>
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin: 2rem 0;">
  <figure style="margin: 0;">
    ...
    <figcaption class="media-caption">Sydney Harbour Bridge from the Manly Ferry.</figcaption>
  </figure>
  <figure style="margin: 0;">
    <img src="sydney_cronulla.jpg" alt="Sunset at Cronulla Beach"
         style="width: 100%; height: 440px; object-fit: cover; border-radius: 6px;" />
    <figcaption class="media-caption">Cronulla at sunset — quieter, more local, worth the train south.</figcaption>
  </figure>
</div>
...
<div class="media-block" style="margin: 2rem 0;">
  <video autoplay muted loop playsinline
         style="width: 100%; max-height: 560px; object-fit: cover; border-radius: 6px; display: block;">
    <source src="sydney_bondi.mp4" type="video/mp4" />
  </video>
